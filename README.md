...
1. [安装traefik ingress](12-安装traefik ingress.md)
1. [使用docker-compose部署 harbor 私有仓库](13-部署harbor私有仓库.md)
1. [使用pods部署nexus](14-使用pods部署nexus.md)
1. [清理集群](15-清理集群.md)
1. [部署 Docker Registry](16-部署Docker-Registry.md)
